...
#SBATCH --mem=240G                # default is 4G per core, 256G. But no one else should be using this node.
...
echo "4 GPU run on 1 node for 6 days. Est 1kh 40M model convergence."
